...
# -----------------------------------
# 변수 period를 기준으로 분할하기로 함(0부터 2까지 학습 데이터, 3가 테스트 데이터)
# 여기에서는 학습 데이터 중에 변수 period가 3의 데이터를 검증 데이터로 하고, 0부터 2까지의 데이터를 학습에 이용합니다.
...
# -----------------------------------
# 변수 period를 기준으로 분할(0부터 2까지가 학습 데이터, 3가 테스트 데이터)
...
# -----------------------------------
# 변수 period를 기준으로 분할(0부터 3까지가 학습 데이터, 4가 테스트 데이터).
