...
| 2023/06 | 파이썬 버전 :  3.9.13 <br>  | Pandas Version - 1.4.4  <br> matplotlib 버전 :  -- <br> 넘파이(numpy) 버전 :  1.23.5 <br> scikit-learn 버전 :  -- <br> tensorflow 버전 :  -- <br> 케라스(keras) 버전 :  --  <br> xgboost 버전 :  1.7.5 <br> lightgbm 버전 :  -- <br> hyperopt 버전 :  -- <br> umap-learn 버전 :  -- # umap |
